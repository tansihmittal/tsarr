      ...
      <div className="rounded-[14px] border border-[#E5E7EB]/80 bg-white shadow-sm lg:max-h-[calc(100vh-150px)] lg:overflow-y-auto scrollbar-hide animate-fade-in">
        <TabsContent value="options">
          <div className="relative rounded-md">
            ...
            <div className="p-4 border-b border-[#E5E7EB]/60">
              <input type="text" value={state.caption} onChange={(e) => updateState({ caption: e.target.value })} placeholder="Add a caption..." className="w-full px-3 py-2 border-2 border-[#E5E7EB] rounded-[10px] focus:border-[#2563EB] focus:outline-none text-sm bg-white" />
            </div>
            <Control title="Font">
              ...
              <div className="flex flex-wrap gap-2">
                {filters.map((filter) => (
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-[10px] text-xs font-medium transition-all duration-200 ${state.filter === filter.id ? "bg-[#2563EB] text-white shadow-md shadow-[#2563EB]/20" : "bg-[#F9FAFB] hover:bg-[#E5E7EB]"}`}
                  >
                    {filter.name}
                  </button>
                ))}
          ...
          <div className="relative rounded-md">
            ...
            <div className="p-4 border-b border-[#E5E7EB]/60">
              <div className="grid grid-cols-1 gap-2">
                ...
                <button onClick={() => updateState({ filter: "nt16", filterIntensity: 80, lightLeak: "subtle", vignette: true, vignetteIntensity: 30, grain: true, grainIntensity: 18, frameColor: "#ffffff", captionFont: "Shadows Into Light", brightness: 102, contrast: 108, saturation: 95, fade: 12 })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">NT16 Polaroid</button>
                <button onClick={() => updateState({ filter: "grd", filterIntensity: 90, lightLeak: "cool", vignette: true, vignetteIntensity: 45, grain: true, grainIntensity: 22, frameColor: "#1a1a1a", captionColor: "#e0e0e0", captionFont: "Georgia", brightness: 90, contrast: 125, saturation: 85, shadows: 15 })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">GRD R Night</button>
                <button onClick={() => updateState({ filter: "kino", filterIntensity: 85, lightLeak: "orange", vignette: true, vignetteIntensity: 35, grain: true, grainIntensity: 20, frameColor: "#f5f0e6", brightness: 100, contrast: 115, saturation: 90, temperature: -5, fade: 15 })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">Kino Cinema</button>
                <button onClick={() => updateState({ filter: "ct100", filterIntensity: 80, lightLeak: "blue", vignette: false, grain: true, grainIntensity: 15, frameColor: "#ffffff", brightness: 102, contrast: 110, saturation: 105, temperature: -15, tint: 5 })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">CT100 Tungsten</button>
              </div>
            </div>
            ...
            <div className="p-4 border-b border-[#E5E7EB]/60">
              <div className="grid grid-cols-1 gap-2">
                ...
                <button onClick={() => updateState({ filter: "ektar", filterIntensity: 90, lightLeak: "none", vignette: false, grain: true, grainIntensity: 10, frameColor: "#ffffff", brightness: 100, contrast: 115, saturation: 140, temperature: 5 })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">Ektar 100</button>
                <button onClick={() => updateState({ filter: "velvia", filterIntensity: 95, lightLeak: "none", vignette: false, grain: true, grainIntensity: 8, frameColor: "#ffffff", brightness: 98, contrast: 125, saturation: 160, shadows: -15 })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">Velvia 50</button>
                <button onClick={() => updateState({ filter: "provia", filterIntensity: 80, lightLeak: "none", vignette: false, grain: true, grainIntensity: 10, frameColor: "#ffffff", brightness: 100, contrast: 108, saturation: 110, temperature: 0 })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">Provia 100</button>
                <button onClick={() => updateState({ filter: "superia", filterIntensity: 85, lightLeak: "warm", vignette: false, grain: true, grainIntensity: 18, frameColor: "#f5f0e6", brightness: 102, contrast: 105, saturation: 115, temperature: 10, fade: 5 })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">Superia 400</button>
                <button onClick={() => updateState({ filter: "gold200", filterIntensity: 85, lightLeak: "warm", vignette: false, grain: true, grainIntensity: 20, frameColor: "#f8f4e8", brightness: 105, contrast: 100, saturation: 120, temperature: 20, fade: 8 })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">Gold 200</button>
                <button onClick={() => updateState({ filter: "ultramax", filterIntensity: 90, lightLeak: "subtle", vignette: false, grain: true, grainIntensity: 15, frameColor: "#ffffff", brightness: 103, contrast: 112, saturation: 130, temperature: 8 })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">Ultramax 400</button>
                <button onClick={() => updateState({ filter: "cinestill", filterIntensity: 90, lightLeak: "orange", vignette: true, vignetteIntensity: 25, grain: true, grainIntensity: 18, frameColor: "#1a1a1a", captionColor: "#e0e0e0", brightness: 100, contrast: 115, saturation: 105, temperature: 15, highlights: 20 })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">CineStill 800T</button>
              </div>
            </div>
            ...
            <div className="p-4 border-b border-[#E5E7EB]/60">
              <div className="grid grid-cols-1 gap-2">
                ...
                <button onClick={() => updateState({ filter: "none", brightness: 95, contrast: 130, saturation: 120, fade: 0, temperature: -10, vignette: true, vignetteIntensity: 40, grain: false, lightLeak: "none" })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">Dramatic</button>
                <button onClick={() => updateState({ filter: "none", brightness: 108, contrast: 95, saturation: 110, fade: 10, temperature: 25, vignette: false, grain: true, grainIntensity: 12, lightLeak: "warm" })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">Golden Hour</button>
                <button onClick={() => updateState({ filter: "none", brightness: 100, contrast: 105, saturation: 0, fade: 5, temperature: 0, vignette: true, vignetteIntensity: 30, grain: true, grainIntensity: 20, lightLeak: "none" })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">Noir B&W</button>
                <button onClick={() => updateState({ filter: "none", brightness: 105, contrast: 100, saturation: 90, fade: 15, temperature: -15, vignette: false, grain: true, grainIntensity: 10, lightLeak: "cool" })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">Cool Breeze</button>
                <button onClick={() => updateState({ filter: "none", brightness: 102, contrast: 115, saturation: 140, fade: 0, temperature: 10, vignette: false, grain: false, lightLeak: "none" })} className="px-3 py-2.5 bg-[#F9FAFB] hover:bg-[#E5E7EB] rounded-[10px] text-xs font-medium transition-all duration-200">Vibrant Pop</button>
              </div>
            </div>
          </div>
        </TabsContent>
